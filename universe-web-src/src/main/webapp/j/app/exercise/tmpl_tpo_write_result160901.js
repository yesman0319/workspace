...
define(function () {
    return ['<div class="right-part1">',
        ...
        '            <button id="btnTpoNext" type="button" class="btn1 btn btn-primary {{if data.nextGroupStatus || data.enableNextBtn}}active{{else}}disabled{{/if}}{{if data.isLast}}active last-question{{/if}}">下一题</button>',
        //'          {{/if}}',
        '        </div>',
        '    </div>',
