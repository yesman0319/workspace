...
define(['common/render', 'app/baseURL', 'baseCookie', 'lib/store'], function(Render, URL, BaseCookie) {
    ...
    var _conf,
        ...
        TMPL = {
            ...
            fanwen: 'app/exercise/tmpl_rewrite_3_reader',
            fuxie: 'app/exercise/tmpl_rewrite_4_copy',
            duan_result: 'app/exercise/tmpl_rewrite_5_duan_result',
            next: 'app/exercise/tmpl_rewrite_6_next',
            pian_result: 'app/exercise/tmpl_rewrite_7_pian_result',
    ...
    var initEvent = function() {
        ...
        $document.on('click', '#btnExercisePiece', copy);
    ...
    var btnen = function() {
        ...
        if (dp == "duan") {
            if ($(this).attr('data') == 'cn') {
                ...
                $("#userContent").removeAttr("disabled")
            }
            ...
            if ($(this).attr('data') == 'cn') {
                ...
                $("#piancn").css("display", "none");
                $(this).attr('data', 'en');
                $(this).html('隐藏模板<span class="all-blue"></span>');
                $("#userContent").attr("disabled", "disabled")
            } else {
                ...
                $("#duanAns").css("display", "none");
                $(this).attr('data', 'cn');
                $(this).html('查看模板<span class="all-blue">（查看后将不判断成绩）</span>');
                $("#userContent").removeAttr("disabled")
            }
        }
    };
    ...
    var renderPian = function() {
        ...
        $.ajax({
            ...
            url: URL.xiaomaURL + "api/v3/reproduction_sample_results",
            type: 'POST',
    ...
    var showRewrite=function(questionId,planDayId,exerciseId,xmTitle){
        ...
        $.ajax(
            {
                url:URL.xiaomaURL+"api/v2/reproduction_questions/"+questionId,
                type:"GET",
                headers: {
                    Authorization: exerciseApi.xiaomaToken
                }  ,
