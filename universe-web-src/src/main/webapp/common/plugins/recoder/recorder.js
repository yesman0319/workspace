var Recorder = {
    ...
    _setupFlashContainer: function(){
        ...
        this.options.flashContainer.setAttribute("style", "position: absolute; left: -9999px; top: -9999px; width: 260px; height: 170px;  border: 16px solid rgba(128, 128, 128, 0.6); border-radius: 5px 5px;");
    ...
    _defaultOnShowFlash: function(){
        ...
        flashContainer.style.left   = ((window.innerWidth  || document.body.offsetWidth)  / 2 - 150) + "px";
        flashContainer.style.top    = ((window.innerHeight || document.body.offsetHeight) / 2 - 20)  + "px";
    },
