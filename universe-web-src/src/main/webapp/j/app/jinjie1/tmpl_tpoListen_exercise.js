  ...
  return [
   ...
   '<div class="right-part2">',
    '{{if data.artical}}',
       ...
       '  <span><a class=" bread-gray tpoListenUnit pointer gray808 mleft25">TPO听力</a><span class="sign1 bread-gray">&gt;</span></span>',
       ...
       /**题目部分**/
       '<div class="Ntpo_left Ntpo_border mright10 tpoPart2" id="tpoListenPart2"></div>',
       ...
       '<div class="Ntpo_right Ntpo_border" id="tpoListenPart3">',
          ...
          '</div>',
          '<audio src="{{data.artical.audio}}" id="audioQuestion" controls="controls" style="width: 310px; height:30px; margin-left:25px;"></audio>',
          '<img src="{{data.artical.picture}}" id="listenImg" style="width: 310px; margin-left:25px; margin-top: 15px; height: 220px;"/>',
                  //两个人对话
