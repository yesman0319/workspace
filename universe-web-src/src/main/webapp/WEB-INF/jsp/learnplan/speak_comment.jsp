...
<head lang="en">
    <meta charset="UTF-8">
    <title>题目分享页-口语</title>
    <%@include file="../include/pub.jsp"%>
    <link rel="stylesheet" href="${cdnPath}/css/common.css"/>
    <link rel="stylesheet" href="${cdnPath}/css/share-speak-comment.css"/>
</head>
<body>
...
<div class="layout">
    <div class="main fl">
        <div class="answer">
         ...
         <%--    <div class="answer-audio" id="answerAudio">
                <audio id="myAudio" src="${question.content}" preload="auto">您的浏览器不支持 audio 标签。</audio>
                <div class="answer-audio-control fl"><i class="answer-audio-control-ic"></i></div>
                <span class="answer-start-time fl">${question.audio_length}</span>
                <div class="answer-audio-bar-bg fl">
                    <div  class="answer-audio-bar"></div>
                </div>
                <span class="answer-total-time fl">${question.audio_length}</span>

            </div> --%>
            <div class="audiojsZ newaudio answer-audio" id="audiojs_wrapper0" style="width: 750px;">
                <audio id="myMusic" src="${question.content}" preload="auto"></audio>
                <div class="play-pauseZ"><p class="playZ"></p>
                    <p class="pauseZ"></p>
                    <p class="loadingZ"></p>
                    <p class="errorZ"></p>
                </div>
                <div class="newscrubberZ scrubberZ" style="width:548px!important;">
                    <div class="progressZ" style="width: 0px;"></div>
                    <div class="loadedZ" style="width: 548px;"></div>
                </div>
