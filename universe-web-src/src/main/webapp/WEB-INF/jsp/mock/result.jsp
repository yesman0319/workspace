...
<style>
    *{color:#232323;}
    ...
    .time_list li{margin-right:60px;}
...
<div class="m-mock f-cb" >
	    <div class="mock-type f-cb">
	        <div class="mock-tit">做题记录<button class="check-score" id="checkScore" user="0">请老师检查</button>  
	        <input class="student-id" type="text" id="studentId" placeholder="所要查询的用户id" value="0"/>
	        <button class="find-result" id="findResult" >查询记录</button></div>
	    </div>
...
<div class="m-pop m-pop-massage">
    <div class="pop-hd">
        ...
        <h3 class="pop-tit">提示！</h3>
        <i class="pop-close JS_pop_close"></i>
    </div>
    <div class="pop-bd">
        <div class="pop-icon"></div>
        <div id="messagetip" class="pop-cnt"></div>
        <div class="pop-btn">
...
<script src="../javascripts/index/jquery-1.8.0.min.js?timestamp=" + new Date().getTime();></script>
