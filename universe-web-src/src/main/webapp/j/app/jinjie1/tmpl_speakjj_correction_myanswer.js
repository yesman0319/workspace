...
define(function(){
    return [
       ...
       '<div class="one-button2">',
        ...
        '  <button type="button" class="btn btn-primary btn2" id="btnNextQuestion2" data-question_id="{{data.question.next_question_id}}" next_status="{{data.question.next_status}}" >下一题</button>',
       '</div>',
       '<div class="h202">',
          '<div>',
