...
public class VideoSectionsForApp extends BaseEntity implements Serializable {
	@JsonInclude
    ...
    private List<LessionsDetailForApp> lessionsDetailForApp;
	public VideoSectionsForApp() {
		super();
	}
	...
	public List<LessionsDetailForApp> getLessionsDetailForApp() {
		return lessionsDetailForApp;
	}
	public void setLessionsDetailForApp(List<LessionsDetailForApp> lessionsDetailForApp) {
		this.lessionsDetailForApp = lessionsDetailForApp;
	}
