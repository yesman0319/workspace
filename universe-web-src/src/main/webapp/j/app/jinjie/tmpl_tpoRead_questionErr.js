...
define(function(){
  return [
       ...
       '     <div class="left25 font13">',
          '       <span class="num repeat-num pointer" id="questionsTabToggle">{{data.currentQuestionIndex+1}}/{{data.questionsLength}}<span class="caret2 pointer" style="color: #929292;" id="nameSanJiao1"></span></span>',
                  '<div class="tpo-points1 " id="questionsTab" style="clear:both; display: none;">',
                      ...
                      '{{if data.currentQuestionIndex+1 == value}}',
                        '<a href="###" class="questionPageTabErr1 point-round-style" data-localIndex={{index}} data-pageNum={{value-1}}>{{value}}</a>',
                      '{{else}}',
                        '<a href="###" class="questionPageTabErr1" data-localIndex={{index}} data-pageNum={{value-1}}>{{value}}</a>',
                      '{{/if}}',
                      '{{/each}}',
                  '</div>',
          ...
          '           <span><span class="N_tpoicon N_ticon_jx" style="cursor: auto;"></span><a class="all-blue font14 img_font_m" id="seeJieXiReadErr2">解析</a></span>',
          '        </div>              ',
          '      </div>',
        ...
        '</table>',
          ...
          ' </div>',
          ' <div>',
          '   <a href="###" class="N_before N_tpo-page" id="preQuestionErr1" style="display: block;"><span class="arrow-left"></span></a>',
          '   <a href="###" class="N_after N_tpo-page" id="nextQuestionErr1"><span class="arrow-right"></span></a>',
          ' </div>',
          '</div>',
                 /**视频部分**/
