 ...
 */
@Controller
@RequestMapping("/mallwechat")
public class MallWechatController {
	private static final Logger logger = LoggerFactory.getLogger(MallWechatController.class);
	@Autowired
	...
	public String loginInit(HttpServletRequest request, HttpServletResponse response,Model model,String errorMsg) {
		...
		if(userInfo==null||userInfo.getId()<0)
		{
			...
			return "wechat/mallwechat";
		}
		else
		{
			return "redirect:/h5/product/pay/lists";
		}
	}
	/**
	 * 用户登录首页
	...
	public String login(HttpServletRequest request, HttpServletResponse response,Model model, String checkCode, String phone, String backUrl,String wechatcode) {
		...
		{
			return "redirect:/wechat/authority/3";
		}
...
//			}
			...
			return "redirect:/mallwechat/index";
	}
}
