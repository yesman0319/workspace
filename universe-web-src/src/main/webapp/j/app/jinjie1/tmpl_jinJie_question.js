...
define(function(){
  return [
       ...
       //  '</table>',
       //  '<div>',
       //    '<a href="###" class="Previous tpo-page" id="preQuestion" style="display: none;"><span class="arrow-left"></span></a>',
       //    '<a href="###" class="Next tpo-page" id="nextQuestion"><span class="arrow-right"></span></a>',
       //  '</div>'
       //  
       //  
       //  
