          ...
          '<div id="tab_record" class="tab-content tpo-write-tab" >',
                ...
                '<div role="tabpanel" class="tab-pane active" id="Integralgain">',
                   ...
                   '<div class="repeat-record">',
                        '<p id="recordTimerP" style="display: block;"><span id="recordTimer" >00:00</span>/<span id="recordTotalLength">00:{{data.not_commit_answer.answer_audio_length}}</span></p>',
                   ...
                   '<div class="two-button2">',
                      ...
                      '<button type="button" class="btn1 btn btn-primary active" id="speak-saved-saveRecord" >提交</button>',
