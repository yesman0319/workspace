var Recorder = {
    ...
    _setupFlashContainer: function(){
        ...
        this.options.flashContainer.setAttribute("style", "position: absolute; left: -9999px; top: -9999px; width: 230px; height: 140px; margin-left: 10px; border-top: 6px solid rgba(128, 128, 128, 0.6); border-bottom: 6px solid rgba(128, 128, 128, 0.6); border-radius: 5px 5px; padding-bottom: 1px; padding-right: 1px;");
//        document.body.appendChild(this.options.flashContainer);
        document.getElementsByClassName("comment-record-wrap")[0].appendChild(this.options.flashContainer);
    },
    ...
    _defaultOnShowFlash: function(){
       ...
       /* flashContainer.style.left   = ((window.innerWidth  || document.body.offsetWidth)  / 2) + "px";
        flashContainer.style.top    = ((window.innerHeight || document.body.offsetHeight) / 2)  + "px";*/
         flashContainer.style.left   = "213px";
        flashContainer.style.top    = "36px";
    },
