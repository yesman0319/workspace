...
define(function(){
  ...
  '{{if data.errorCount != 0}}',
   '<div class="two-button2">',
    '<button type="button" class="btn btn-primary btn9" id="againJinJie1">再练一遍</button>',
    '<button type="button" class="btn btn-primary btn2" data-question_id="{{data.question_id}}" data-pickArtical="false" id="errOnlyJinJieErr1">重做错题</button>',
   ...
   '</div>',
    ...
    '{{else}}',
     '<div class="two-button">',
      '<button type="button" class="btn btn-primary btn9" id="againJinJie1">再来一遍</button>',
      //'{{if !data.is_last_question}}',
      //'<button type="button" class="btn btn-primary btn1" id="nextUnitRead" data-next_question_id="{{data.next_question_id}}"  data-next_group_name="{{data.next_group_name}}" data-next_type_name="{{data.next_type_name}}" data-next_rate="{{data.next_rate}}" data-is_last_question="{{data.is_last_question}}">完成</button>',
      //'{{/if}}',
      '{{if !data.isFromPlan}}',
