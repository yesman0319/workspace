...
public class LiveRoomDetailDto  implements Serializable {
	/** 
    ...
    private List<LiveTopicVo> listTopics;
    private List<LiveCourseVo> listCourses;
    
	public LiveRoomDetailDto() {
		super();
	}
	...
	public List<LiveTopicVo> getListTopics() {
		return listTopics;
	}

	public void setListTopics(List<LiveTopicVo> listTopics) {
		this.listTopics = listTopics;
	}

	public List<LiveCourseVo> getListCourses() {
		return listCourses;
	}

	public void setListCourses(List<LiveCourseVo> listCourses) {
