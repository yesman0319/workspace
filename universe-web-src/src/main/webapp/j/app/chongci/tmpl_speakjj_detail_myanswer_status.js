    ...
    return [
        ...
        '</div>',
            ...
            '{{if data.answer_type==3}}',
              ...
              /*  '<ul class="inf_list mleft25">',
                '<li class="img_li"><img  class="img_liimg" src="{{data.userHeadPic}}"></li>',
                '<li class="font_li" style="padding: 5px;">',
                ' <div class="date_t"> <span class="font14 black mright20">丹丹</span>  <span class="mright10" >北京国贸</span> <span class="mright20">写作</span>手机号:<span >15713344332</span> </div>',
                '<div class="font_lidiv"><span class="width25">英文基本功扎实，英文综合能力素质强。多年授课经验，帮助多名学生取得口语高分.</span></div>',
                '</li>',
                '<li class="font_li"><div class="dis_in type-radio type-radi01 robRadio pointer jjspeak_teacherRadio"></div></li>',
                ' <li style="clear: both;"></li>',
                '</ul>',*/
