...
public class CourseForAppById extends BaseEntity implements Serializable {
	/** 
    ...
    private String hasBuy;//是否已购买(0:未购买；1:已购买；2:已删除)
    private Integer btnFlag;//按钮状态
    private Integer lastPartId;//最后观看视频集
    private String tips;//页面提示
    private Long endTime;//权限结束时间
    ...
    private List<VideoGroupsForApp> listVideoGroups;
    private List<VideoCourses> listVideoCourses;
	...
	public void setLastPartId(Integer lastPartId) {
	...
	public List<VideoCourses> getListVideoCourses() {
		return listVideoCourses;
	}
	public void setListVideoCourses(List<VideoCourses> listVideoCourses) {
		this.listVideoCourses = listVideoCourses;
	}
	...
	public List<VideoGroupsForApp> getListVideoGroups() {
		return listVideoGroups;
	}
	public void setListVideoGroups(List<VideoGroupsForApp> listVideoGroups) {
		this.listVideoGroups = listVideoGroups;
	}
