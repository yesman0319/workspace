 ...
 * 复述功能
 */
define(['require', 'common/uniqueAjax', 'common/render', 'xml2json', 'app/baseURL', 'common/valiEnter', 'baseCookie', 'audioControl'], function (require, uniqueAjax, Render, xml2json, URL, ValiEnter, BaseCookie, ctrlAudio) {
    ...
    TpoWrite.Doing.prototype.manageQuestionData = function (_this, data) {
        ...
        //记录单元和当前题的ID信息
        _this.CurrQuestionId = question.question_id;
        ...
        //}
        finalData.question_id=question.question_id;
        ...
        finalData.strSample = strSample.replace(/\{.+?\}/g,function($all,$child,$index,str){
            ...
            //console.log("句子");
            //console.log(_this.answerGroups);
    ...
    TpoWrite.Result.prototype.showUserResult = function (currGroupId, currIsLast) {
        ...
        promise.then(function (data) {
            if (!data.status) {
                ...
                renderData.rate=data.rate;
                renderData.nextGroupStatus = data.next_question_status;
                renderData.avgSpeed = data.avg_spend;
