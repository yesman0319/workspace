...
define(function () {
    return [
        ...
        '                       </p>',
        '                       <textarea id="jjWriteAnswer1" onpaste="return false" spellcheck="false" autocomplete="off" class="left25 form-control jijingwrite-tarea" rows="5" placeholder="请输入作文，150-500个单词"></textarea>',
        '                       <div class="one-button5" style="margin-top: 50px;margin-left: 0;">',
        '                           <button id="btnSubmit" type="button" class="btn1 btn btn-primary">保存</button>',
        '                       </div>',
        '                   </div>',
        '                </div>',
        '            </div>',
