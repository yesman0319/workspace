...
//    '<span><a class="bold bread-gray jinJieUnit pointer">练习报告</a></span>',
...
//    '<span class="unit"><a class="pointer jinJieUnit">TPO阅读列表</a></span>',
  ...
  '{{if data.rate != 100}}',
   '<div class="two-button2">',
    ...
    '<button type="button" class="btn btn-primary btn2" data-question_id="{{data.question_id}}" data-pickArtical="false" id="errOnlyJinJie1">重做错题</button>',
