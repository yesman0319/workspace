...
define(function(){
  return [
    '<form role="form" id="form" autocomplete="off" style="position:relative;" >',
      ...
      ' <input type="text" class="tel inputxt unameBlur" id="uname" placeholder="请输入手机号" nullmsg="请输入手机号" datatype="m" errormsg="请输入正确的11位手机号码">',
      '</div>',

      '<div class="form-group" style="display: inline-block;margin-bottom:0px;">',
      '<input type="text" class="inputxt" style="width: 200px;height: 45px;margin-right:20px;" id="img_code" name="img_code" nullmsg="请输入验证码" placeholder="请输入验证码">',
      '</div>',
      '<div id="codeImg_div" class="form-group " style="display: inline-block;">',
      '</div>',

      '<div class="form-group"  style="display: inline-block;">',
      ' <input type="text" class="inputxt" style="width: 200px;height: 45px;margin-right:20px;" id="code" name="code" nullmsg="请输入短信验证码" datatype="/^\\d{6}$/" errormsg="短信验证码由6位数字组成" placeholder="短信验证码">',
      '</div>',
